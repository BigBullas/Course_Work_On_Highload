...
CREATE INDEX idx_comments_pin_id ON Комментарии (ID_пина - хэш-индекс);
...
Будет реализовано за счёт отдельного сервиса, который будет рекомендовать сначала пины просмотренных ранее категорий, а затем уже через ИИ, который будет выдавать похожие категории за счёт опыта других пользователей.  

#### Поиск определённого пина

Будет реализовано при помощи Elasticsearch. Elasticsearch - это распределенный поисковый и аналитический движок, построенный на основе Apache Lucene. Он предоставляет мощные средства для хранения, поиска и анализа данных в реальном времени.
...
| Сервис     | Хостинг | Конфигурация                                       | Cores | Cnt | Покупка, € | Амортизация, € |
|------------|---------|----------------------------------------------------|-------|-----|------------|----------------|
| Auth       | own     | 1xAMD EPYC 7443P/2x8ГБ 3200MHz DDR4/1xNVMe256Gb    | 24    | 7   | 4500       | 75             |
| User       | own     | 1xAMD EPYC 7443P/2x8ГБ 3200MHz DDR4/1xNVMe256Gb    | 24    | 2   | 4500       | 75             |
| Pins       | own     | 2xAMD EPYC 7773X/2x16ГБ 3200MHz DDR4/2xNVMe4T      | 128   | 12  | 14 000     | 234            |
| Feedback   | own     | 2x6338/2x16GB/1xNVMe256Gb/2x25Gb/s                 | 64    | 5   | 8 000      | 117            |
| Statistics | own     | 1xAMD EPYC 9754/4x64ГБ 4200MHz DDR5/4xHDD2.4Tb     | 128   | 10  | 17 800     | 297            |
| nginx      | own     | 2x6338/4x8GB/2xNVMe4T/2x25Gb/s                     | 64    | 10  | 8 000      | 96             |
