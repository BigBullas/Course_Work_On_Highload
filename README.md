...
- Изображения: X * 10 Mb = 
- Видео: X * 50 Mb =
- Комментарии: максимум 500 символов

#### Сетевой трафик и rps

Сводная таблица RPS по типовым действиям

| **Действие**          | **Тип** | **RPS**  | **RPD** |
|-----------------------|---------|----------|---------|
| Регистрация           | Запись | 0.54     | 46.6 тысяч |
| Авторизация           | Чтение | 3 тыс    | 2.5 млн |
| Просмотр пинов        | Чтение | 127 тыс  | 11 млрд |
| Комментирование пинов | Запись | 8 тыс    | 675 млн |
| Добавление реакции    | Запись | 23 тыс   | 2 млрд |
| Создание пина         | Запись | 1 тыс    | 112.5 млн |
| Создание досок        | Запись | 86       | 7.5 млн |
| Сохранение пинов      | Запись | 11.6 тыс | 1 млрд |
